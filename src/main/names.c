...
{"while",	CF(do_while),	0,	0,	-1,	0x1,	0x0,	{PP_WHILE,   PREC_FN,	  0}},
{"for",		CF(do_for),	0,	0,	-1,	0x1,	0x0,	{PP_FOR,     PREC_FN,	  0}},
...
{"<-",		CF(do_set),	1,	100,	2,	0x3,	0x0,	{PP_ASSIGN,  PREC_LEFT,	  1}},
{"=",		CF(do_set),	3,	100,	2,	0x3,	0x0,	{PP_ASSIGN,  PREC_EQ,	  1}},
{"<<-",		CF(do_set),	2,	100,	2,	0x3,	0x1,	{PP_ASSIGN2, PREC_LEFT,	  1}},
{"{",		CF(do_begin),	0,	0,	-1,	-1,	-1,	{PP_CURLY,   PREC_FN,	  0}},
{"(",		CF(do_paren),	0,	1,	1,	0x0,	0x0,	{PP_PAREN,   PREC_FN,	  0}},
{".subset",	CF(do_subset_dflt), 1,	1,	-1,	-1,	-1,	{PP_FUNCALL, PREC_FN,	  0}},
{".subset2",	CF(do_subset2_dflt), 2,	1,	2,	-1,	-1,	{PP_FUNCALL, PREC_FN,	  0}},
{"[",		CF(do_subset),	1,	0,	-1,	-1,	0x0,	{PP_SUBSET,  PREC_SUBSET, 0}},
{"[[",		CF(do_subset2),	2,	0,	2,	0x2,	0x0,	{PP_SUBSET,  PREC_SUBSET, 0}},
{"$",		CF(do_subset3),	3,	0,	2,	-1,	0x0,	{PP_DOLLAR,  PREC_DOLLAR, 0}},
...
{"length",	CF(do_length),	0,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
...
{"c",		CF(do_c),	0,	0,	-1,	-1,	0x0,	{PP_FUNCALL, PREC_FN,	0}}, /* in bind.c */
{"unlist",	CF(do_unlist),	0,	10,	3,	-1,	-1,	{PP_FUNCALL, PREC_FN,	0}},
{"cbind",	CF(do_bind),	1,	10,	-1,	-1,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"rbind",	CF(do_bind),	2,	10,	-1,	-1,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
...
{"round",	CF(do_Math2),	10001,	11,	2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"atan",	CF(do_atan),	10002,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"log",		CF(do_log),	10003,	11,	-1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"signif",	CF(do_Math2),	10004,	11,	2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"abs",		CF(do_abs),	6,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

/* KH(1999/09/12)-> complex: {"abs", CF(do_math1, 0, 1, 1,	-1,	-1, {PP_FUNCALL, PREC_FN,	0}}, */
{"floor",	CF(do_math1),	1,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"ceiling",	CF(do_math1),	2,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"sqrt",	CF(do_math1),	3,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"sign",	CF(do_math1),	4,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"trunc",	CF(do_math1),	5,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"exp",		CF(do_math1),	10,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"expm1",	CF(do_math1),	11,	11,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"log1p",	CF(do_math1),	12,	11,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"cos",		CF(do_math1),	20,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"sin",		CF(do_math1),	21,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"tan",		CF(do_math1),	22,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"acos",	CF(do_math1),	23,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"asin",	CF(do_math1),	24,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"cosh",	CF(do_math1),	30,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"sinh",	CF(do_math1),	31,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"tanh",	CF(do_math1),	32,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"acosh",	CF(do_math1),	33,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"asinh",	CF(do_math1),	34,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"atanh",	CF(do_math1),	35,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"lgamma",	CF(do_math1),	40,	11,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"gamma",	CF(do_math1),	41,	11,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

/* Polygamma Functions */

{"digamma",	CF(do_math1),	42,	11,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"trigamma",	CF(do_math1),	43,	11,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
/* {"tetragamma",	CF(do_math1),	44,	11,	1,	-1,	-1,	{PP_FUNCALL, PREC_FN,	0}},
{"pentagamma",	CF(do_math1),	45,	11,	1,	-1,	-1,	{PP_FUNCALL, PREC_FN,	0}},*/
{"gammaCody",	CF(do_math1),	46,	11,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
/* see "psigamma" below !*/

/* Mathematical Functions of Two Numeric (+ 1-2 int) Variables */

{"atan2",	CF(do_math2),	0,	11,	2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"lbeta",	CF(do_math2),	2,	11,	2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"beta",	CF(do_math2),	3,	11,	2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"lchoose",	CF(do_math2),	4,	11,	2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"choose",	CF(do_math2),	5,	11,	2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dchisq",	CF(do_math2),	6,	11,	2+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"pchisq",	CF(do_math2),	7,	11,	2+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qchisq",	CF(do_math2),	8,	11,	2+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dexp",	CF(do_math2),	9,	11,	2+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"pexp",	CF(do_math2),	10,	11,	2+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qexp",	CF(do_math2),	11,	11,	2+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dgeom",	CF(do_math2),	12,	11,	2+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"pgeom",	CF(do_math2),	13,	11,	2+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qgeom",	CF(do_math2),	14,	11,	2+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dpois",	CF(do_math2),	15,	11,	2+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"ppois",	CF(do_math2),	16,	11,	2+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qpois",	CF(do_math2),	17,	11,	2+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dt",		CF(do_math2),	18,	11,	2+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"pt",		CF(do_math2),	19,	11,	2+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qt",		CF(do_math2),	20,	11,	2+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dsignrank",	CF(do_math2),	21,	11,	2+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"psignrank",	CF(do_math2),	22,	11,	2+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qsignrank",	CF(do_math2),	23,	11,	2+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"besselJ",	CF(do_math2),	24,	11,	2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"besselY",	CF(do_math2),	25,	11,	2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"psigamma",	CF(do_math2),	26,	11,	2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},


/* Mathematical Functions of a Complex Argument */

{"Re",		CF(do_cmathfuns),	1,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"Im",		CF(do_cmathfuns),	2,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"Mod",		CF(do_cmathfuns),	3,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"Arg",		CF(do_cmathfuns),	4,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"Conj",	CF(do_cmathfuns),	5,	1,	1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
/* {"abs",	CF(do_cmathfuns),	6,	1,	1,	-1,	-1,	{PP_FUNCALL, PREC_FN,	0}},*/


/* Mathematical Functions of Three Numeric (+ 1-2 int) Variables */

{"dbeta",	CF(do_math3),	1,	11,	3+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"pbeta",	CF(do_math3),	2,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qbeta",	CF(do_math3),	3,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dbinom",	CF(do_math3),	4,	11,	3+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"pbinom",	CF(do_math3),	5,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qbinom",	CF(do_math3),	6,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dcauchy",	CF(do_math3),	7,	11,	3+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"pcauchy",	CF(do_math3),	8,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qcauchy",	CF(do_math3),	9,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"df",		CF(do_math3),	10,	11,	3+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"pf",		CF(do_math3),	11,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qf",		CF(do_math3),	12,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dgamma",	CF(do_math3),	13,	11,	3+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"pgamma",	CF(do_math3),	14,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qgamma",	CF(do_math3),	15,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dlnorm",	CF(do_math3),	16,	11,	3+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"plnorm",	CF(do_math3),	17,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qlnorm",	CF(do_math3),	18,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dlogis",	CF(do_math3),	19,	11,	3+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"plogis",	CF(do_math3),	20,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qlogis",	CF(do_math3),	21,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dnbinom",	CF(do_math3),	22,	11,	3+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"pnbinom",	CF(do_math3),	23,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qnbinom",	CF(do_math3),	24,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dnorm",	CF(do_math3),	25,	11,	3+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"pnorm",	CF(do_math3),	26,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qnorm",	CF(do_math3),	27,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dunif",	CF(do_math3),	28,	11,	3+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"punif",	CF(do_math3),	29,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qunif",	CF(do_math3),	30,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dweibull",	CF(do_math3),	31,	11,	3+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"pweibull",	CF(do_math3),	32,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qweibull",	CF(do_math3),	33,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dnchisq",	CF(do_math3),	34,	11,	3+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"pnchisq",	CF(do_math3),	35,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qnchisq",	CF(do_math3),	36,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dnt",		CF(do_math3),	37,	11,	3+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"pnt",		CF(do_math3),	38,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qnt",		CF(do_math3),	39,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dwilcox",	CF(do_math3),	40,	11,	3+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"pwilcox",	CF(do_math3),	41,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qwilcox",	CF(do_math3),	42,	11,	3+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"besselI",	CF(do_math3),	43,	11,	3,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"besselK",	CF(do_math3),	44,	11,	3,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

/* Mathematical Functions of Four Numeric (+ 1-2 int) Variables */

{"dhyper",	CF(do_math4),	1,	11,	4+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"phyper",	CF(do_math4),	2,	11,	4+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qhyper",	CF(do_math4),	3,	11,	4+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dnbeta",	CF(do_math4),	4,	11,	4+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"pnbeta",	CF(do_math4),	5,	11,	4+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qnbeta",	CF(do_math4),	6,	11,	4+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dnf",		CF(do_math4),	7,	11,	4+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"pnf",		CF(do_math4),	8,	11,	4+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qnf",		CF(do_math4),	9,	11,	4+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},

{"dtukey",	CF(do_math4),	10,	11,	4+1,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"ptukey",	CF(do_math4),	11,	11,	4+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"qtukey",	CF(do_math4),	12,	11,	4+2,	0x0,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
...
{"rep",		CF(do_rep),		0,	11,	2,	-1,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
{"list",	CF(do_makelist),	1,	1,	-1,	-1,	0x0,	{PP_FUNCALL, PREC_FN,	0}},
