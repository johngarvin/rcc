...
/* Binary Operators */
{"+",		CF(do_arith),	PLUSOP,	1,	2,	0,	0,	{PP_BINARY,  PREC_SUM,	  0}},
{"-",		CF(do_arith),	MINUSOP,1,	2,	0,	0,	{PP_BINARY,  PREC_SUM,	  0}},
{"*",		CF(do_arith),	TIMESOP,1,	2,	0,	0,	{PP_BINARY,  PREC_PROD,	  0}},
{"/",		CF(do_arith),	DIVOP,	1,	2,	0,	0,	{PP_BINARY2, PREC_PROD,	  0}},
{"^",		CF(do_arith),	POWOP,	1,	2,	0,	0,	{PP_BINARY2, PREC_POWER,  1}},
{"%%",		CF(do_arith),	MODOP,	1,	2,	0,	0,	{PP_BINARY2, PREC_PERCENT,0}},
{"%/%",		CF(do_arith),	IDIVOP,	1,	2,	0,	0,	{PP_BINARY2, PREC_PERCENT,0}},
{"%*%",		CF(do_matprod),	0,	1,	2,	0,	0,	{PP_BINARY,  PREC_PERCENT,0}},
{"crossprod",	CF(do_matprod),	1,	11,	2,	0,	0,	{PP_FUNCALL, PREC_FN,	  0}},
{"==",		CF(do_relop),	EQOP,	1,	2,	0,	0,	{PP_BINARY,  PREC_COMPARE,0}},
{"!=",		CF(do_relop),	NEOP,	1,	2,	0,	0,	{PP_BINARY,  PREC_COMPARE,0}},
{"<",		CF(do_relop),	LTOP,	1,	2,	0,	0,	{PP_BINARY,  PREC_COMPARE,0}},
{"<=",		CF(do_relop),	LEOP,	1,	2,	0,	0,	{PP_BINARY,  PREC_COMPARE,0}},
{">=",		CF(do_relop),	GEOP,	1,	2,	0,	0,	{PP_BINARY,  PREC_COMPARE,0}},
{">",		CF(do_relop),	GTOP,	1,	2,	0,	0,	{PP_BINARY,  PREC_COMPARE,0}},
{"&",		CF(do_logic),	1,	1,	2,	0,	0,	{PP_BINARY,  PREC_AND,	  0}},
{"|",		CF(do_logic),	2,	1,	2,	0,	0,	{PP_BINARY,  PREC_OR,	  0}},
{"!",		CF(do_logic),	3,	1,	1,	0,	0,	{PP_UNARY,   PREC_NOT,	  0}},
{"&&",		CF(do_logic2),	1,	0,	2,	0,	0,	{PP_BINARY,  PREC_AND,	  0}},
{"||",		CF(do_logic2),	2,	0,	2,	0,	0,	{PP_BINARY,  PREC_OR,	  0}},
{":",		CF(do_seq),	0,	1,	2,	0,	0,	{PP_BINARY2, PREC_COLON,  0}},
{"~",		CF(do_tilde),	0,	0,	2,	0,	0,	{PP_BINARY,  PREC_TILDE,  0}},


/* Logic Related Functions */

{"all",		CF(do_logic3),	1,	11,	-1,	-1,	-1,	{PP_FUNCALL, PREC_FN,	  0}},
{"any",		CF(do_logic3),	2,	11,	-1,	-1,	-1,	{PP_FUNCALL, PREC_FN,	  0}},
...
/* printname	c-entry		offset	eval	arity	points	escape	pp-kind	precedence	rightassoc
 * ---------	-------		------	----	-----	------	------	------- ----------	----------*/
{"vector",	CF(do_makevector),0,	11,	2,	-1,	-1,	{PP_FUNCALL, PREC_FN,	0}},
