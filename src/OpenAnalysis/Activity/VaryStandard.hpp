...
class VaryStandard {
  public:
    ...
    OA_ptr<DataFlow::DataFlowSetImplIterator<Alias::AliasTag> > getIndepSetIterator();
    ...
    OA_ptr<DataFlow::DataFlowSetImpl<Alias::AliasTag> > getInVarySet(ExprHandle call);
    ...
    void insertIndepTag(Alias::AliasTag tag);
  ...
  private:
    // data members
    std::map<StmtHandle,OA_ptr<DataFlow::DataFlowSetImpl<Alias::AliasTag> > > mOutVary;
    std::map<ExprHandle,OA_ptr<DataFlow::DataFlowSetImpl<Alias::AliasTag> > > mInVary;
    OA_ptr<DataFlow::DataFlowSetImpl<Alias::AliasTag> >  mIndepTagSet;
