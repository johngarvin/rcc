...
public:
  InterActive(OA_ptr<Alias::Interface> alias); 
  ~InterActive() {}
  ...
  //! Return an iterator over set of active symhandles in given proc
  OA_ptr<SymHandleIterator> getActiveSymIterator(ProcHandle proc);
