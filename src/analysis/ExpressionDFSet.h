...
// File: ExpressionDFSet.h
//
// Author: John Garvin (garvin@cs.rice.edu)

//#include <include/R/R_RInternals.h>

#ifndef EXPRESSION_DF_SET_H
#define EXPRESSION_DF_SET_H

#include <OpenAnalysis/DataFlow/DataFlowSet.hpp>

#include <analysis/VarRef.h>

class ExpressionDFSet : public OA::DataFlow::DataFlowSet {
public:
  class ExpressionDFSetIterator;

  typedef std::set<SEXP> MySet;

  explicit ExpressionDFSet();
  ~ExpressionDFSet();
  ...
  OA::OA_ptr<ExpressionDFSet> meet(OA::OA_ptr<ExpressionDFSet> other);

  OA::OA_ptr<ExpressionDFSetIterator> getIterator() const;

  bool lookup(SEXP e) const;

  class ExpressionDFSetIterator {
  public:
    explicit ExpressionDFSetIterator(OA::OA_ptr<MySet> set);
    ~ExpressionDFSetIterator();
