/* ManagerAutoLivenessBV.hpp
   NOTE: This file was automatically generated by DFAGen.  It is the interface
         for the LivenessBV analysis manager.
*/

#ifndef ManagerAutoLivenessBV_H
#define ManagerAutoLivenessBV_H

//--------------------------------------------------------------------
// OpenAnalysis headers
#include <OpenAnalysis/Utils/OA_ptr.hpp>
#include <OpenAnalysis/IRInterface/auto_LivenessBVIRInterface.hpp>
#include <OpenAnalysis/DFAGen/LivenessBV/auto_LivenessBV.hpp>
    ...
    : public virtual DataFlow::CFGDFProblem
{
  public:
    ...
    //*****************************************************************
    //! Construct new object to perform LivenessBV analysis
    ManagerLivenessBV(OA_ptr<LivenessBVIRInterface> _ir);
  ...
  private:
    ...
    // Debugging Methods
    //*****************************************************************
    void dumpset(OA_ptr<DataFlow::DFSetBitImpl<Alias::AliasTag > > inSet);



    OA_ptr<LivenessBVIRInterface> mIR;
    OA_ptr<Alias::Interface> mAlias;
    OA_ptr<LivenessBV> mLivenessBVMap;
