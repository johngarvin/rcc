    ...
    : public virtual DataFlow::CFGDFProblem
{
  public:
    ...
    //*****************************************************************
    //! Construct new object to perform ReachingDefs analysis
    ManagerReachingDefs(OA_ptr<ReachingDefsIRInterface> _ir);
  ...
  private:
    ...
    // Debugging Methods
    //*****************************************************************
    void dumpset(OA_ptr<DataFlow::DataFlowSetImpl<StmtHandle > > inSet);



    OA_ptr<ReachingDefsIRInterface> mIR;
    OA_ptr<Alias::Interface> mAlias;
    OA_ptr<ReachingDefs> mReachingDefsMap;
